                        ...
                        <form id="form-tambah" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group" id="nama_footer_container">
                                            <label for="name">Nama Footer</label>
                                            <input type="text" class="form-control" name="nama_footer" id="nama_footer"
                                                placeholder="Nama Footer ">
                                        </div>
                                    </div>
                                    <div class="col-12">
                        ...
                        <form id="form-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group" id="nama_footer_edit_container">
                                            <label for="name">Nama Footer</label>
                                            <input type="text" class="form-control" name="nama_footer" id="nama_footer_edit"
                                                placeholder="Nama Footer ">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group" id="link_edit_container">
                                            <label for="name">Link Footer</label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group" id="kategori_edit_container">
                                            <label for="name">Kategori Footer</label>
                                            <input type="text" class="form-control" name="kategori" id="kategori_edit"
                                                placeholder="Kategori Footer ">
                                        </div>
                                    </div>
            ...
            $('.btn-edit').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('#id').val(data.id);
                        $('#nama_footer_edit').val(data.nama_footer);
